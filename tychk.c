...
static TYPE_CONS_PTR enum_expr_tvs ( TYPE_CONS_PTR *ppacc, EXPR_CONS_PTR pexpr, SRC_POS_C pos ) {  // OBSOLETE
  assert( ppacc );
  assert( pexpr );
...
static TYPE_CONS_PTR enum_tvs ( TYPE_CONS_PTR *ppacc, TYPE_CONS_PTR pty, SRC_POS_C pos ) { // OBSOLETE
  assert( ppacc );
  assert( pty );
